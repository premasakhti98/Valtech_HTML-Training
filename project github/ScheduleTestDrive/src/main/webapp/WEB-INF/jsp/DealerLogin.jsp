...
<script
	...
	background-image: url("C:/Prema/Miniproject/images/dealer.jpg");
...
<body>
  <form action="dealerloginprocess" method="POST">
...
<table>
		<tbody>
			<div class="container">
				...
				<br> <br>
				<button id="Button2" class="btn btn-info" onclick="location.href = 'DealerRegister'">Register</button>
			</div>
		</table>
		</table>
